...
{
    [Fact]
    public async void CreateBookReview_Returns201AndBookReviewIsCreated()
    {
        // prepare
    ...
    [Fact]
    public async void UpdateBookReview_Returns204AndBookReviewIsUpdated()
    {
        // prepare
        var app = new WebAppFactory<Program>();
        var client = app.CreateDefaultClient();
    ...
    [Fact]
    public async void DeleteBookReview_Returns204AndBookReviewIsDeleted()
    {
        // prepare
        var app = new WebAppFactory<Program>();
        var client = app.CreateDefaultClient();
